...
BuildRequires : swig
Patch1: 0001-python-3.11-fix.patch
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666734045
...
mv %{buildroot}/usr/lib/python3.11/site-packages/gpg-*.egg/gpg %{buildroot}/usr/lib/python3.11/site-packages/gpg
## install_append end
