...
Source0  : https://www.gnupg.org/ftp/gcrypt/gpgme/gpgme-1.22.0.tar.bz2
Source1  : https://www.gnupg.org/ftp/gcrypt/gpgme/gpgme-1.22.0.tar.bz2.sig
...
Patch1: 0001-qt-tests-fix.patch
Patch2: 0002-qt6-tests-fix.patch
Patch3: 0003-Hack-in-a-version-number-setuptools-allows.patch
Patch4: 0004-Enable-passing-extra-opts-to-setup.py.patch
...
%prep
%setup -q -n gpgme-1.22.0
cd %{_builddir}/gpgme-1.22.0
%patch -P 1 -p1
%patch -P 2 -p1
%patch -P 3 -p1
%patch -P 4 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697660925
...
/usr/lib64/libgpgme.so.11.31.0
/usr/lib64/libgpgmepp.so.6
/usr/lib64/libgpgmepp.so.6.19.0
